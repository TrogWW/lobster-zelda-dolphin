...
namespace Scripting
{
  ...
  static void InitDLLSpecificAPIs()
  {
    ...
    dll_defined_scriptContext_apis.RegisterOnInstructionHitCallback = RegisterOnInstructionReachedCallback_impl;
    dll_defined_scriptContext_apis.RegisterOnInstructionHitWithAutoDeregistrationCallback = RegisterOnInstructionReachedWithAutoDeregistrationCallback_impl;
    ...
    dll_defined_scriptContext_apis.RunOnInstructionHitCallbacks = RunOnInstructionReachedCallbacks_impl;
    ...
    dll_defined_scriptContext_apis.UnregisterOnInstructionHitCallback = UnregisterOnInstructionReachedCallback_impl;
    ...
    Dolphin_Defined_ScriptContext_APIs::SCRIPT_END_CALLBACK_FUNCTION_TYPE script_end_callback_fn_ptr)
  {
    ...
    if (PythonDynamicLibrary::python_lib_ptr == nullptr)
    {
      ...
      if (dolphinDefinedScriptContext_APIs.GetScriptReturnCode(opaque_script_context_handle) != 0)
      {
        dolphinDefinedScriptContext_APIs.SetIsScriptActive(opaque_script_context_handle, 0);
        dolphinDefinedScriptContext_APIs.GetScriptEndCallbackFunction(opaque_script_context_handle)(opaque_script_context_handle, dolphinDefinedScriptContext_APIs.GetUniqueScriptIdentifier(opaque_script_context_handle));
